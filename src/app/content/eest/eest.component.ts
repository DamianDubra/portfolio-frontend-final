...
@Component({
  selector: 'app-eest',
  templateUrl: './eest.component.html',
  styleUrls: ['./eest.component.css']
})
export class EestComponent implements OnInit {
  carta: any;
  ...
  ngOnInit() {
    this.http.get('https://portfoliobackenddamian1.onrender.com/cartas/4').subscribe((data) => {
      this.carta = data;
