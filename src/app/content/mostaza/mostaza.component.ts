...
@Component({
  selector: 'app-mostaza',
  templateUrl: './mostaza.component.html',
  styleUrls: ['./mostaza.component.css']
})
export class MostazaComponent implements OnInit {
  carta: any;
  ...
  ngOnInit() {
    this.http.get('https://portfoliobackenddamian1.onrender.com/cartas/8').subscribe((data) => {
      this.carta = data;
