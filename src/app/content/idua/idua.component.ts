...
@Component({
  selector: 'app-idua',
  templateUrl: './idua.component.html',
  styleUrls: ['./idua.component.css']
})
export class IduaComponent implements OnInit {
  carta: any;
  ...
  ngOnInit() {
    this.http.get('https://portfoliobackenddamian1.onrender.com/cartas/7').subscribe((data) => {
      this.carta = data;
