...
@Component({
  selector: 'app-hmf',
  templateUrl: './hmf.component.html',
  styleUrls: ['./hmf.component.css']
})
export class HmfComponent implements OnInit {
  carta: any;
  ...
  ngOnInit() {
    this.http.get('https://portfoliobackenddamian1.onrender.com/cartas/6').subscribe((data) => {
      this.carta = data;
