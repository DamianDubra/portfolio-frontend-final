...
@Component({
  selector: 'app-first-atempp',
  templateUrl: './first-atempp.component.html',
  styleUrls: ['./first-atempp.component.css']
})
export class FirstAtemppComponent implements OnInit {
  carta: any;
  ...
  ngOnInit() {
    this.http.get('https://portfoliobackenddamian1.onrender.com/cartas/5').subscribe((data) => {
      this.carta = data;
