...
@Component({
  selector: 'app-argprgm',
  templateUrl: './argprgm.component.html',
  styleUrls: ['./argprgm.component.css']
})
export class ArgprgmComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get('https://portfoliobackenddamian1.onrender.com/cartas/2').subscribe((data) => {
      this.carta = data;
